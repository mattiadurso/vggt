...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="images",
        help="Sub-directory containing images within the scene directory",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
...
def demo_fn(args):
    ...
    image_dir = os.path.join(args.scene_dir, args.imgs_dir)
    image_path_list = (
    ...
    base_image_path_list = [
        os.path.relpath(path, image_dir) for path in image_path_list
    ]
    ...
    ba = "BA" if args.use_ba else "wo_BA"
